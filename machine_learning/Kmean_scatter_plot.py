"""
This program performs k-means clustering using the optimal k
value selected with elbow method. Returns the scatter plots
between the explanatory and response variables with each cluster
